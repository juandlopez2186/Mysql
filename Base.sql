...
/*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select hora,(select pla from conductor where pla=930) from horarios;
/*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select hora,(select pla from bus where pla=930) from horarios;
/*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select hora,(select nomrut from rutas where nop=9) from horarios;
/*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select hora,(select nom from bus where nom="daniel") from horarios;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select hora,(select nom from conductor where nom="julian") from horarios;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select pla,(select hora from horarios where hora="05:00") from conductor;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select pla,(select nomrut from rutas where nop=9) from conductor;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select pla,(select nom from bus where nom="daniel") from conductor;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select pla,(select hora from horarios where hora="07:00") from conductor;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select pla,(select pla from bus where pla=930) from conductor;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/	
    select pla,(select pla from conductor where pla=930) from bus;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/    
    select pla,(select nom from conductor where nom="julian") from bus;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/    
    select pla,(select hora from horarios where hora="05:00") from bus;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/    
    select pla,(select hora from horarios where hora="07:00") from bus;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/    
    select pla,(select hora from horarios where hora="19:00") from bus;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/    
    select nomrut,(select hora from horarios where hora="05:00") from rutas;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/    
    select nomrut,(select nom from conductor where nom="julian") from rutas;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/    
    select nomrut,(select pla from conductor where pla=930) from rutas;
	/*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select nomrut,(select pla from bus where pla=930) from rutas;
    /*--///--///-//--/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/--/-//-/-/-/-/-/-/-/-/-/-/-/-/////////////////////////////////-/-/-/-/-/-/--/-/-/-/-/-/-/-/-/-/-/-/-/-/-//-/-/-/-/-/-/-/-/-/-/-/-/-/-/*/
    select nomrut,(select nop from bus where nop=9) from rutas;